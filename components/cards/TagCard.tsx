...
const TagCard = ({
  ...
  if (compact) {
    return isButton ? (
      <button onClick={handleClick} className="flex justify-baseline gap-2">
        {content}
      </button>
    ) : (
  ...
  return (
    <Link href={ROUTES.TAG(_id)} className="shadow-light100_darknone">
      <article className="background-light900_dark200 rounded-2xl border px-8 py-10 sm:w-[260px] light-border flex w-full flex-col">
